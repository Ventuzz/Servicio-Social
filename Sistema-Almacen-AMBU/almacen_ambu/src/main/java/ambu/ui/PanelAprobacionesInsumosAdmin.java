...
/*-----------------------------------------------------------------------
    Panel que se encarga de las apobaciones de Insumos para Administrador
 ------------------------------------------------------------------------*/
public class PanelAprobacionesInsumosAdmin extends JPanel {
    ...
    public PanelAprobacionesInsumosAdmin(long adminUsuarioId, boolean esAdminVista, TicketsService service) {
    ...
    @Override public void actionPerformed(ActionEvent e) {
        ...
        if (id == null) {
            JOptionPane.showMessageDialog(PanelAprobacionesInsumosAdmin.this, "Selecciona un ticket.", "Aviso", JOptionPane.WARNING_MESSAGE);
            return;
        }
        int r = JOptionPane.showConfirmDialog(PanelAprobacionesInsumosAdmin.this,
        ...
        new SwingWorker<Boolean, Void>() {
            ...
            @Override protected void done() {
                try {
                    boolean ok = get();
                    if (ok) {
                        JOptionPane.showMessageDialog(PanelAprobacionesInsumosAdmin.this, "Ticket cerrado.");
                        cargarCabeceras();
                        cargarDetalles(id);
                    } else {
                        JOptionPane.showMessageDialog(PanelAprobacionesInsumosAdmin.this, "No se pudo cerrar (verifica estado).", "Aviso", JOptionPane.WARNING_MESSAGE);
                    }
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(PanelAprobacionesInsumosAdmin.this, "Error: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        }.execute();
    }
        ...
        new SwingWorker<Boolean, Void>() {
            ...
            @Override protected void done() {
                try {
                    boolean ok = get();
                    if (ok) {
                        JOptionPane.showMessageDialog(PanelAprobacionesInsumosAdmin.this, "Solicitud aprobada.");
                        cargarCabeceras();
                    } else {
                        JOptionPane.showMessageDialog(PanelAprobacionesInsumosAdmin.this, "No fue posible aprobar (verifica estado).", "Aviso", JOptionPane.WARNING_MESSAGE);
                    }
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(PanelAprobacionesInsumosAdmin.this, "Error: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
        ...
        new SwingWorker<Boolean, Void>() {
            ...
            @Override protected void done() {
                try {
                    boolean ok = get();
                    if (ok) {
                        JOptionPane.showMessageDialog(PanelAprobacionesInsumosAdmin.this, "Solicitud rechazada.");
                        cargarCabeceras();
                    } else {
                        JOptionPane.showMessageDialog(PanelAprobacionesInsumosAdmin.this, "No fue posible rechazar (verifica estado).", "Aviso", JOptionPane.WARNING_MESSAGE);
                    }
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(PanelAprobacionesInsumosAdmin.this, "Error: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
        ...
        AgregarInsumo dlg = new AgregarInsumo(SwingUtilities.getWindowAncestor(this), id, (idExistencia, cantidad, unidad, obs) -> {
            new SwingWorker<Integer, Void>() {
                ...
                @Override protected void done() {
                    try {
                        get();
                        JOptionPane.showMessageDialog(PanelAprobacionesInsumosAdmin.this, "Insumo agregado.");
                        cargarDetalles(id);
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(PanelAprobacionesInsumosAdmin.this, "Error al agregar: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }.execute();
        });
        ...
        new SwingWorker<List<CabeceraRow>, Void>() {
            ...
            @Override protected void done() {
                try {
                    ...
                    JOptionPane.showMessageDialog(PanelAprobacionesInsumosAdmin.this, "No se pudieron cargar los tickets:\n" + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                    actualizarBotonesPorSeleccion();
                }
            }
        }.execute();
        ...
        new SwingWorker<List<DetalleRow>, Void>() {
            ...
            @Override protected void done() {
                try {
                    ...
                    JOptionPane.showMessageDialog(PanelAprobacionesInsumosAdmin.this, "No se pudo cargar el detalle:\n" + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        }.execute();
    }
